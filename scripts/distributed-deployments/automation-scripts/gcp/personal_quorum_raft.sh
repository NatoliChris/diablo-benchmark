...
CONFIGFILE="DBW-NASDAQ-CONFIG-2.yaml"
RESULTPATH="/home/natc/PhD/research/benchmark-system/diablo-experiments-paper/results/NASDAQ/2secondaries/quorum-raft/"
...
for i in `seq 1 $NUMREPEATS`; do
  ...
  (cd "$DIABLOPATH/scripts/distributed-deployments/$CHAIN"; bash gcp_start.sh ${BCIPS[0]} ${BCIPS[1]} ${BCIPS[2]})
