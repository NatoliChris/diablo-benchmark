...
/*
* Init ; The Init method is called when instantiating the chaincode
* Also executes when the chaincode is upgraded
* Best pratice is to have any ledger initialization in a separate function -- see initLedger()
 */
