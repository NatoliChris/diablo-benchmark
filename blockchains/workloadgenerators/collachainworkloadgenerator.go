...
// CollachainWorkloadGenerator is the workload generator implementation for the Ethereum blockchain
type CollachainWorkloadGenerator struct {
...
func (e *CollachainWorkloadGenerator) NewGenerator(chainConfig *configs.ChainConfig, benchConfig *configs.BenchConfig) WorkloadGenerator {
	return &CollachainWorkloadGenerator{BenchConfig: benchConfig, ChainConfig: chainConfig}
}
...
// blockchain nodes
func (e *CollachainWorkloadGenerator) BlockchainSetup() error {
	// TODO implement
...
func (e *CollachainWorkloadGenerator) InitParams() error {

	// Connect to the blockchain
	c, err := ethclient.Dial(fmt.Sprintf("http://%s:8545", (strings.Split(e.ChainConfig.Nodes[0], ":"))[0]))
...
func (e *CollachainWorkloadGenerator) CreateAccount() (interface{}, error) {
...
func (e *CollachainWorkloadGenerator) DeployContract(fromPivKey []byte, contractPath string) (string, error) {
...
func (e *CollachainWorkloadGenerator) CompileContract(contractPath string) (*compiler.Contract, error) {
...
func (e *CollachainWorkloadGenerator) CreateContractDeployTX(fromPrivKey []byte, contractPath string) ([]byte, error) {
...
func (e *CollachainWorkloadGenerator) getCallDataBytes(paramType string, val string) ([]byte, error) {
...
func (e *CollachainWorkloadGenerator) CreateInteractionTX(fromPrivKey []byte, contractAddress string, functionName string, contractParams []configs.ContractParam, value string) ([]byte, error) {
...
func (e *CollachainWorkloadGenerator) CreateSignedTransaction(fromPrivKey []byte, toAddress string, value *big.Int, data []byte) ([]byte, error) {
...
func (e *CollachainWorkloadGenerator) generateSimpleWorkload() (Workload, error) {
...
func (e *CollachainWorkloadGenerator) generateContractWorkload() (Workload, error) {
...
func (e *CollachainWorkloadGenerator) generatePremadeWorkload() (Workload, error) {
...
func (e *CollachainWorkloadGenerator) GenerateWorkload() (Workload, error) {
